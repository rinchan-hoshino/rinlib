...
| 26.1.x | Not targeted | NeoForge `26.1.2.48-beta` | Fabric API `0.148.2+26.1.2` | 25 | NeoForge implemented; Fabric blocked by missing Yarn/intermediary/official mappings |
...
- `26.1.1`: Implemented NeoForge `26.1.1.15-beta`; Fabric skipped because Yarn/official mappings are unavailable for `26.1.1`.
